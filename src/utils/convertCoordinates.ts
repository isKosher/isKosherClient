...
proj4.defs([
  ...
  ["EPSG:2039", "+proj=tmerc +lat_0=31.73439361111111 +lon_0=35.20451694444445 +k=1.0000067 +x_0=219529.584 +y_0=626907.39 +ellps=GRS80 +units=m +no_defs"],
 ...
 * @returns {[number, number]} - Returns an array [latitude, longitude]
 */
export function convertITMToWGS84(x: number, y: number): [number, number] {
